...
CREATE TABLE IF NOT EXISTS bands (
    ...
    bandcamp_url         TEXT,
    bandcamp_snippet     TEXT,
    bandcamp_image_url   TEXT,
    instagram_url        TEXT,
    instagram_snippet    TEXT,
    ...
    with get_conn() as conn:
        conn.execute(
            """UPDATE bands SET
               ...
               bandcamp_url=?, bandcamp_album_id=?, bandcamp_snippet=?, bandcamp_image_url=?,
               instagram_url=?, instagram_snippet=?, instagram_image_url=?, other_urls=?,
            ...
            (
                ...
                result.bandcamp_snippet,
                result.bandcamp_image_url,
                result.instagram_url,
                result.instagram_snippet,
